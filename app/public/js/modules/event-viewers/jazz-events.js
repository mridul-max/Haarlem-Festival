class JazzEventList extends EventsList {
    ...
    async init(container) {
        ...
        sortRow.classList.add('row', 'mb-4');
        let sortHeader = document.createElement('h2');
        sortHeader.innerText = 'Sort by';
        sortHeader.classList.add('mb-3');
        let sorts = document.createElement('select');
        sorts.classList.add('form-select', 'w-50');
        ...
        timeFilter.classList.add('row', 'mb-4');
        let timeHeader = document.createElement('h2');
        timeHeader.innerText = 'Filter by Time';
        timeHeader.classList.add('mb-3');
        // Start Time
        let timeStartHeader = document.createElement('h3');
        timeStartHeader.innerText = 'From';
        timeStartHeader.classList.add('mb-2');
        let timeStart = document.createElement('select');
        timeStart.classList.add('form-select', 'w-50', 'mb-3');
        ...
        timeEndHeader.classList.add('mb-2');
        let timeEnd = document.createElement('select');
        timeEnd.classList.add('form-select', 'w-50', 'mb-3');
        ...
        dayFilter.classList.add('row', 'mb-4');
        let dayHeader = document.createElement('h2');
        dayHeader.innerText = 'Filter by Day';
        dayHeader.classList.add('mb-3');
        ...
        for (let date of dates) {
            ...
            day.classList.add('form-check', 'mb-2');
    ...
    addEvent(event) {
        ...
        eventContainer.classList.add('row', 'card', 'mb-4', 'p-3');
        eventContainer.id = 'event-' + event.id;

        let rowTitle = document.createElement('div');
        rowTitle.classList.add('row', 'mb-3');
        ...
        rowButtons.classList.add('row', 'justify-content-end', 'gx-2', 'px-0');
